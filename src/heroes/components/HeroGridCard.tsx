      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1">
            ...
            <Progress value={80} activeColor="bg-blue-500" className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={90} activeColor="bg-green-500" className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={100} activeColor="bg-purple-500" className="h-2" />
          </div>
        </div>
